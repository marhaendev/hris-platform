    ...
    return (
        <div className="p-8 space-y-8">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-3xl font-bold text-slate-800 tracking-tight">Buat Notifikasi Baru</h1>
                    <p className="text-slate-500 font-medium italic">Kirim pengumuman atau peringatan ke pengguna sistem</p>
                </div>
            </div>
            ...
            <Card className="border-none shadow-xl shadow-slate-200/50 rounded-3xl overflow-hidden bg-white/70 backdrop-blur-sm">
                <CardHeader className="border-b border-slate-100 bg-slate-50/30 p-8">
                    <CardTitle className="text-xl font-black text-slate-800 flex items-center gap-2">
                        <Bell className="h-5 w-5 text-primary" /> Informasi Notifikasi
                    </CardTitle>
                    <CardDescription className="italic font-medium">Lengkapi detail notifikasi di bawah ini</CardDescription>
                </CardHeader>
